...
from cmrg.layers.gcn_dgi import GCN
from cmrg.layers.readout import AvgReadout
from cmrg.layers.discriminator import Discriminator
import torch
...
class DGI(nn.Module):
    ...
    def forward(self, seq1_top, seq2_top, seq1_con, seq2_con, sparse, msk, samp_bias1, samp_bias2):
        # topology
